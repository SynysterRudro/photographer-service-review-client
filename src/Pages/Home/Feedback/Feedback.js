...
const Feedback = () => {
    return (
        <div>
            <h2 className="text-5xl text-orange-500 text-center font-bold">Feedback</h2>
                ...
                <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                    <div className="flex flex-col items-center mx-12 lg:mx-0">
                        <div className="relative text-center">
                            ...
                            <p className="px-6 py-1 text-lg italic">This guy is amazing. I hired him at my concert to take photos of our band and he did tremendous job.</p>
                    ...
                    <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
                        <div className="relative text-center">
                            ...
                            <p className="px-6 py-1 text-lg italic">Wedding photographs is very precious thing. It is not just a memory,each and every photo indicates our new journey.I hired this guy for this big ocassion and the result was mindblowing. Must try him.</p>
